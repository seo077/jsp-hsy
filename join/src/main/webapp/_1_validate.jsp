...
<body>
    <h1 id="title" style="color: #519259; margin-top: 10px; font-size: 3em;">가입하기</h1><br>
    <form action="_2_join.jsp">
        ...
        <input type="button" value="확인" onclick="checkVal(form)" style="background-color: #519259; color: white; font-size: 1.5em; border: none; width: 15%; height: 50px; margin-bottom: 20px;">
    </form>
