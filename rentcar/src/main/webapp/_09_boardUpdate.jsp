...
<body>
	...
	<!-- 모든 화면에 고정 -->
	<div class="container">
		<form method="post" action="_09_boardUpdatePro.jsp?boardNo=<%=boardNo %>">	
				...
				<table class="table">
					...
					<tbody>
							<tr>
								...
								<td colspan="2"><input type="text" value="<%=board.getTitle() %>" name="title" style="width:90%; height:100%"></td>
							</tr>
							<tr>
								<td>작성자</td>
							...
							<tr>
								...
								<td colspan="2" style="min-height: 200px;"><textarea name ="content" style="width:90%; height:100%"><%=board.getContent() %></textarea></td>
							</tr>
					</tbody>
				</table>
			</div>
			<input type="submit" id="write_btn" value="수정하기">
		</form>
	</div>
